...
- `scripts/`: CLI helpers (training, sampling, fairness analysis). Prefer parameterized scripts over notebooks for repeatability.
...
- Use type hints everywhere; prefer pure functions; inject sessions/clients for testability.
- Target regression coverage for any bug fix.
