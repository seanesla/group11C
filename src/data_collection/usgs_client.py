...
class USGSClient:
    ...
    def __init__(self, rate_limit_delay: float = 1.0, timeout: Optional[int] = None):
        ...
        Args:
            ...
            timeout: Request timeout in seconds (default: USGS_TIMEOUT env var or 30)
        """
        default_timeout = self._get_validated_timeout("USGS_TIMEOUT", 30)
    ...
    def _make_request(self, url: str, params: Dict[str, Any], retries: int = 3) -> requests.Response:
        ...
        raise last_exc or RuntimeError("Unknown USGS request failure")
